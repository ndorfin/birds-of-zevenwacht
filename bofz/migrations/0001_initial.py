# Generated by Django 5.1.6 on 2025-05-12 13:11

import bofz.models.area
import bofz.models.bird
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('short_name', models.CharField(help_text='What should we call them?', max_length=16, verbose_name='Short name')),
                ('full_name', models.CharField(blank=True, db_comment='Avoids problems with first, last, family, and surnames', default='', help_text='Their full name', max_length=32, verbose_name='Full name')),
                ('email', models.EmailField(blank=True, default='', help_text='Used as their username, and our way of staying in contact', max_length=64, verbose_name='Email address')),
            ],
        ),
        migrations.CreateModel(
            name='RedListLevel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(default=bofz.models.area.Area.get_default_pk, help_text='Which Area was this Sighting recorded in?', on_delete=django.db.models.deletion.CASCADE, to='bofz.area')),
                ('bird', models.ForeignKey(default=bofz.models.bird.Bird.get_default_pk, help_text='Select the species you observed in this Sighting', on_delete=django.db.models.deletion.CASCADE, to='bofz.bird')),
                ('observers', models.ManyToManyField(help_text='Who observed these birds?', to='bofz.person')),
